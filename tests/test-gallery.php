...
EOF;
	...
	function test_shortcode_no_gallery_style_back_compat() {
		...
		$static   = $this->get_gallery_instance_id( $gallery );
		$expected = <<<EOF
<div id='rpbt-related-gallery-$static' class='gallery related-gallery related-galleryid-{$args['post_id']} gallery-columns-3 gallery-size-medium'><dl class='gallery-item' role='figure' aria-label='Gallery image with caption: {$related_post->post_title}'>
<dt class='gallery-icon'>
<a href='{$permalink}'><img></a>
</dt>
