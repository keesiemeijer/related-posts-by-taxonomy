...
function km_rpbt_related_posts_by_taxonomy( $post_id = 0, $taxonomies = 'category', $args = '' ) {
	_deprecated_function( __FUNCTION__, '2.4.2', 'km_rpbt_query_related_posts()' );
...
function km_rpbt_get_default_args() {
	_deprecated_function( __FUNCTION__, '2.4.2', 'km_rpbt_get_query_vars()' );
...
function km_rpbt_related_posts_by_taxonomy_validate_ids( $ids ) {
	_deprecated_function( __FUNCTION__, '2.4.2', 'km_rpbt_validate_ids()' );
...
function km_rpbt_post_title_link( $post, $title_attr = false ) {
	_deprecated_function( __FUNCTION__, '2.4.2', 'km_rpbt_post_link()' );
...
function km_rpbt_get_related_post_title_link( $post, $title_attr = false ) {
	_deprecated_function( __FUNCTION__, '2.4.2', 'km_rpbt_get_post_link()' );
