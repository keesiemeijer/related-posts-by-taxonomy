<p class="rpbt_posts_per_page">
	...
	<input id="<?php echo $this->get_field_id( 'posts_per_page' ); ?>" name="<?php echo $this->get_field_name( 'posts_per_page' ); ?>" value="<?php echo esc_attr( $i['posts_per_page'] ); ?>" size="3" class="tiny-text" step="1" min="-1" type="number" />
	<br/>
