...
function getPostField(field) {
	...
	if (__WEBPACK_IMPORTED_MODULE_0_lodash_isUndefined___default()(_wpGutenbergPost)) {
		return '';
	}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash_isEmpty__ = __webpack_require__(21);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash_debounce__ = __webpack_require__(138);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash_debounce___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_lodash_debounce__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_lodash_pickBy__ = __webpack_require__(72);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_lodash_isUndefined__ = __webpack_require__(47);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__includes_data__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__includes_query_panel___ = __webpack_require__(7);
	...
	_createClass(RelatedPostsBlock, [{
		...
		value: function render() {
			...
			if (__WEBPACK_IMPORTED_MODULE_2_lodash_isUndefined___default()(post_types) || !post_types) {
				...
				checkedPostTypes = Object(__WEBPACK_IMPORTED_MODULE_4__includes_data__["b" /* getPostField */])('type');
			}
			...
			var inspectorControls = focus && wp.element.createElement(
				...
				wp.element.createElement(__WEBPACK_IMPORTED_MODULE_5__includes_query_panel___["a" /* default */], {
			...
			var loading = '';
			var postsFound = 0;
			if (__WEBPACK_IMPORTED_MODULE_2_lodash_isUndefined___default()(relatedPosts)) {
			...
			if (loading || !focus) {
				...
				return [inspectorControls, (!focus || !postsFound) && wp.element.createElement(
					...
					__WEBPACK_IMPORTED_MODULE_2_lodash_isUndefined___default()(relatedPosts) ? wp.element.createElement(Spinner, null) : '',
					loading,
...
var applyWithAPIData = withAPIData(function (props) {
	...
	var postID = Object(__WEBPACK_IMPORTED_MODULE_4__includes_data__["b" /* getPostField */])('id');
	var postType = Object(__WEBPACK_IMPORTED_MODULE_4__includes_data__["b" /* getPostField */])('type');
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__post_type_control___ = __webpack_require__(8);
...
var DataView = __webpack_require__(26),
